    ...
    public class AccountController : Controller
    {
        ...
        public IActionResult Login()
        {
            ...
            if (userId != null)
            {
                ...
                _notyfService.Success("Bạn đã đăng nhập");
                return RedirectToAction("Index", "Home");
            }

            return View(); // nếu không còn phiên đăng nhập
        }
        ...
        public IActionResult ConfirmChangePass(string username)
        {
            ...
            using (var client = new SmtpClient())
            {
                ...
                message.From.Add(new MailboxAddress("ThuyTo", "tongthuan15092003@gmail.com"));
        ...
        public IActionResult Login(User user)
        {
            ...
            try
            {
                ...
                var CheckLogin = _context.Users.FirstOrDefault(
                    m => m.UserName.ToLower() == user.UserName.ToLower() && m.Password == password
                );
        ...
        public IActionResult Register()
        {
            ...
            if (userId != null)
            {
                _notyfService.Error("Bạn đã có tài khoản !");
                return RedirectToAction("Index", "Home");
            }
